...
public class UserController {
    ...
    private String fileUploadPath;//读取配置文件中的下载路径
    ...
    public String upload(@RequestParam MultipartFile file) throws IOException {
        ...
        String type = FileUtil.extName(originalFilename);   //获取文件的扩展名，不带"."     就是获取文件的后缀
        // 定义一个文件唯一的标识码
        String uuid = IdUtil.fastSimpleUUID();
        String fileUUID = uuid + StrUtil.DOT + type;
        File uploadFile = new File(fileUploadPath + fileUUID);  //这是文件，fileUploadPath + fileUUID是路径和文件名
